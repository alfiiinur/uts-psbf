...
<body>
    ...
    <div class="container">
        <form action="/karyawan" method="post">
            ...
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="ttl" required />
                <label class="form-label" for="form1Example1">Tempat Tanggal Lahir</label>
            </div>
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="no_rek" required />
                <label class="form-label" for="form1Example1">No Rekening</label>
            </div>
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="alamat" required />
                <label class="form-label" for="form1Example1">Alamat</label>
            </div>
            <div class="form-outline mb-4">
                <input type="number" id="form1Example1" class="form-control" name="no_telepon" required />
