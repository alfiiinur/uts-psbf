    ...
    <div class="container">
        <form action="/warga" method="post">
            ...
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="nik" required />
            ...
            <div class="form-outline mb-4">
                <input type="number" id="form1Example1" class="form-control" name="no_telp" required />
                <label class="form-label" for="form1Example1">Nomor Telpon</label>
            </div>
