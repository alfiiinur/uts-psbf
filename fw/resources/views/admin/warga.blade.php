    ...
    <div class="container">
        ...
        <table class="table table-hover table-bordered results">
            <thead>
                ...
                <a href="/cetakExcel" class="btn btn-warning me-2 my-3 py-2 shadow-lg " target="_blank">Cetak Excel</a>
                <a href="/cetakWord" class="btn btn-primary me-2 my-3 py-2 shadow-lg " target="_blank"
