...
<body>
    ...
    <h1 class=" text-center my-5 display-3 fw-bold ls-tight">
        Tambah Produk Sampah<br />
    </h1>
    <div class="container">
        <form action="/produk" method="post">
            @csrf
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="jenis_sampah" required />
                <label class="form-label" for="form1Example1">Jenis Sampah</label>
            </div>
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="satuan" required />
                <label class="form-label" for="form1Example1">Satuan</label>
            </div>
            <div class="form-outline mb-4">
                <input type="text" id="form1Example1" class="form-control" name="harga" required />
                <label class="form-label" for="form1Example1">Harga</label>
            </div>
            <div class="form-outline mb-4">
                <input type="file" id="form1Example1" class="form-control" name="image" required />
